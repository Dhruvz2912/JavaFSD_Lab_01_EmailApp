...
public class DriverClass {
	...
	public static void main(String[] args) {
		...
		String lastName = "Dalwadi";

		System.out.println("Welcome to Email Application");
		System.out.println("To specify your department, enter your corresponding department number: ");
		...
		default: {
			System.out.println("Invalid department option chosen.Please choose a value" + "between 1 & 4");
			System.exit(-1);
		}
		}
